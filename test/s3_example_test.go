...
func TestTerraformLambdaExample(t *testing.T) {
	...
	assert.Contains(t, planOut, "module.s3.aws_s3_bucket_policy.this will be created")
	assert.Contains(t, planOut, "module.s3.aws_s3_bucket_public_access_block.this will be created")
	assert.Contains(t, planOut, "Plan: 3 to add, 0 to change, 0 to destroy.")
}
